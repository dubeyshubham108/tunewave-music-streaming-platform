    ...
    return (
        ...
        <div className="w-full flex justify-between items-center font-semibold">
                ...
                <div className="flex items-center gap-4">
                    <p className="px-4 py-1 bg-white text-black cursor-pointer text-[15px] rounded-full hidden md:block">
                        Explore Premium
                    </p>
                    ...
                    <p className="px-4 py-1 bg-white text-black cursor-pointer text-[15px] rounded-full">
                        Logout
                    </p>
                </div>
            </div>
